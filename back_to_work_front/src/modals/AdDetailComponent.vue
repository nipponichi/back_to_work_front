<template>
  ...
  <!-- Grid editable de pujas -->
  <div v-if="showBidGrid" class="p-4 mt-6 bg-gray-100 rounded-lg">
    ...
    <table class="min-w-full text-left">
      ...
      <tbody>
        <tr v-for="(bid, index) in bids" :key="index" class="bg-white border-b">
          <td class="py-2 px-4">
            <input 
              v-model="bid.user" 
              class="w-full px-2 py-1 border rounded text-gray-800"
          ...
          <td class="py-2 px-4">
            <input 
              ...
              class="w-full px-2 py-1 border rounded text-gray-800"
              placeholder="Descripción de la puja"
            />
          </td>
          <td class="py-2 px-4">
            <button 

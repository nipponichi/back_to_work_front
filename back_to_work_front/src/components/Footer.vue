<template>
  <div v-if="route.path !== '/'" class="bg-gray-800 p-4 min-h-54 flex flex-col md:flex-row items-center md:justify-between space-y-4 md:space-y-0">
    <ul class="flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-4 list-none items-center">
      ...
      <li>
        <RouterLink to="/contact" class="px-5 py-2.5 flex items-center justify-center text-white bg-transparent hover:bg-transparent rounded-lg text-base font-medium transition-all duration-300 border border-white/20 hover:border-transparent shadow-sm hover:shadow-md backdrop-blur-sm">
          Contacto
        </RouterLink>
      </li>
    </ul>
    <div class="flex space-x-4">
      ...
      <a href="https://instagram.com" target="_blank"
         class="text-gray-400 hover:text-pink-500 transform hover:scale-110 transition-transform transition-colors duration-300">
      ...
      <a href="https://twitter.com" target="_blank"
         class="text-gray-400 hover:text-blue-400 transform hover:scale-110 transition-transform transition-colors duration-300">
      ...
      <a href="https://linkedin.com" target="_blank"
         class="text-gray-400 hover:text-blue-600 transform hover:scale-110 transition-transform transition-colors duration-300">
